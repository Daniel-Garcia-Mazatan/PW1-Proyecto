<%-- 
    Document   : e3
    Created on : 8/11/2020, 02:23:42 AM
    Author     : DanielGM
--%>
    ...
    <div class="seccion-noticias-completa">
        ...
        <div class="seccion-de-noticias-anno">
            ...
            <div id="list-item-2" class="card-anno text-left">
                ...
                <div class="card-body">
                    <!-- <h5 class="card-title">Special title treatment</h5> -->
                    <p class="card-text">Nintendo ha anunciado la salida de un juego que contiene las 3 versiones de Super Mario en 3D, Super...</p>
                    <a href="pagina_de_noticia.jsp" class="btn btn-primary">Ver más</a>
                </div>
                <div class="card-footer">
                    04/Oct/2020
