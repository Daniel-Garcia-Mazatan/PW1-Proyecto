<%-- 
    Document   : evaluar_noticia
    Created on : 8/11/2020, 02:26:22 AM
    Author     : DanielGM
--%>
...
<head>
    ...
    <link rel="stylesheet" href="Styles/pagina_evaluar_noticia.css">
...
<body background="body-image.jpg">
  ...
  <!-- ////////////////////////////////////////////////////////////////////////////////
    ...
    <div class="evaluacion-de-noticias">Evaluación de noticias</div>

    <div class="seccion-de-noticias">
        <!-- AQUI EMPIEZA TODO EL CONJUNTO DE EVALUACION -->
        <div class="seccion-noticias-evaluacion">
            <div id="list-item-2" class="card-evaluar-noticia text-left">
            ...
            <div class="seccion-evaluacion">
                <div class="botones">
                    <a class="btna">Aprobar</a>
                    <a class="btnr">Rechazar</a>
                </div>
                <div class="comentario">
                    <label for="comentarios" class="comentarios">Sugerencias</label>
                    <a class="btns btn-primary">Subir sugerencia</a>
                </div>
                <div class="comentarios">
                    <input type="text" autocomplete="off" name="comentarios" id="comentarios"/> 
                </div>
            </div>
        </div>
        <!-- AQUI TERMINA TODO EL CONJUNTO DE EVALUACION -->
