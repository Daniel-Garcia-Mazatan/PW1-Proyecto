<%-- 
    Document   : pagina_ayuda
    Created on : 8/11/2020, 02:30:12 AM
    Author     : DanielGM
--%>
...
<body background="body-image.jpg">
  ...
  <!-- ////////////////////////////////////////////////////////////////////////////////
    ...
    <div class="info">Manual de usuario</div>

    <div id="list-item-2" class="card-info text-left">
      <div class="card-body" background="LOGO.png">
          <!-- <h5 class="card-title">Special title treatment</h5> -->
          <p class="card-text"> Bienvenido a Continental Games, la mejor pagina para informarse sobre el mundo 
              gamer actual.
          </p>
          <p class="card-text"> Para ingresar a las noticias sobre Nintendo, debe hacer clic sobre el boton llamado
              Nintendo en la barra superior.
            </p>
