<%-- 
    Document   : nintendo
    Created on : 8/11/2020, 02:22:39 AM
    Author     : DanielGM
--%>
...
<body background="body-image.jpg">
  ...
  <!-- ////////////////////////////////////////////////////////////////////////////////
    ...
    <div class="seccion-noticias-completa">
        ...
        <data-spy data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
        ...
        <div class="seccion-de-noticias-anno">
            ...
            <div id="list-item-2" class="card-anno text-left">
                ...
                <div class="card-body">
                     <!-- <h5 class="card-title">Special title treatment</h5> -->
                    <p class="card-text">Ya esta presente ante los fans la maravillosa convencion de videojuegos mas famosa del mundo. Contara con...</p>
                    <a href="pagina_de_noticia.jsp" class="btn btn-primary">Ver más</a>
                </div>
                <div class="card-footer">
                  14/Sep/2020
