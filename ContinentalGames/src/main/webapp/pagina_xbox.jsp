<%-- 
    Document   : xbox
    Created on : 8/11/2020, 02:19:56 AM
    Author     : DanielGM
--%>
  ...
  <!-- ////////////////////////////////////////////////////////////////////////////////
    ...
    <div class="seccion-noticias-completa">
        ...
        <div class="seccion-de-noticias-novedad">
            ...
            <div id="list-item-1" class="card-novedad text-left">
                <div class="card-header">
                    X BOX series x ya tiene precio
                </div>
                <img src="https://news.xbox.com/es-latam/wp-content/uploads/sites/4/2020/02/XboxSeriesXHERO.jpg?fit=1200%2C675" class="card-img" alt="min min">
                <div class="card-body">
                    <!-- <h5 class="card-title">Special title treatment</h5> -->
                    <p class="card-text">La próxima consola de Microsoft, incluida la Xbox Series S, ya tiene precio oficial, fecha de preventa y de lanzamiento. Te contamos todo lo que sabemos de la llegada de la Xbox Series X.</p>
        ...
        <div class="seccion-de-noticias-anno">
            ...
            <!-- aqui comienza la noticia -->
            <div id="list-item-2" class="card-anno text-left">
                <div class="card-header">
                ...
                <div class="card-body">
                    <!-- <h5 class="card-title">Special title treatment</h5> -->
                    <p class="card-text">Nintendo ha anunciado la salida de un juego que contiene las 3 versiones de Super Mario en 3D, Super Mario 64, Super...</p>
                    <a href="pagina_de_noticia.jsp" class="btn btn-primary">Ver más</a>
                </div>
                <div class="card-footer">
                    hace 1 semana
        ...
        <div class="seccion-de-noticias-mas-antiguas">
            ...
            <!-- aqui comienza la noticia -->
            <div id="list-item-1" class="card-mas-antiguas text-left">
                <div class="card-header">
                    Min Min llega a Smash
                </div>
                <div class="categoria">Consolas</div>
